...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.signature.com/dialog/oauth';
  options.tokenURL = options.tokenURL || 'https://graph.signature.com/oauth/access_token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('https://graph.signature.com/me', accessToken, function (err, body, res) {
