...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://myserverurl.com/dialog/authorize';
  options.tokenURL = options.tokenURL || 'http://myserverurl.com/oauth/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('http://myserverurl.com/api/userinfo', accessToken, function (err, body, res) {
